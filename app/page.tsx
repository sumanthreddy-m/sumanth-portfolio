...
export default function Portfolio() {
  ...
  const downloadResume = () => {
    const resumeContent = `
      ...
      <head>
        <meta charset="UTF-8">
        <title>Sumanth Reddy Majjiga - Resume</title>
        <style>
          body {
      ...
      <body>
        <div class="header">
          ...
          <div class="contact-info">
            <p>Chittoor, Andhra Pradesh, India | +91-9515685601</p>
            <p>sumanthmajjiga8348@gmail.com | linkedin.com/in/majjiga-sumanth-reddy8348</p>
          </div>
        </div>
  ...
  const skills = [
    ...
    { name: "AI/ML", level: 65, icon: Brain },
  ]
  ...
  const projects = [
    {
      ...
      tech: ["Spring Boot", "Angular", "MySQL", "RESTful APIs"],
      features: ["Role-based Security", "Real-time Updates", "Ticket Assignment"],
    },
    {
      title: "Real-time Vehicle Collision Detection",
      description:
        "Advanced system using bounding box methodology to detect and alert about potential vehicle collisions.",
      tech: ["Python", "Computer Vision", "Machine Learning", "Real-time Processing"],
      features: ["Bounding Box Detection", "Real-time Alerts", "Collision Prediction"],
    },
    {
      title: "VPC Endpoint & FlowLogs Implementation",
      description:
        "Enhanced AWS cloud infrastructure security and visibility through VPC endpoints and comprehensive logging.",
      tech: ["AWS", "VPC", "CloudWatch", "Security"],
      features: ["Enhanced Security", "Traffic Analysis", "Operational Monitoring"],
    },
  ]

  const certifications = [
    { name: "Cloud Computing", provider: "NPTEL", icon: Cloud },
    { name: "Data Science", provider: "EXECLR", icon: Brain },
    { name: "Blockchain", provider: "Udemy", icon: Cpu },
    { name: "Prompt Engineering", provider: "Deeplearning.ai", icon: Brain },
  ]
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        <div
          className="absolute w-96 h-96 bg-primary/5 rounded-full blur-3xl animate-pulse-subtle"
          style={{
        ...
        />
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-accent/3 rounded-full blur-2xl animate-float" />
        <div className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-primary/3 rounded-full blur-2xl animate-rotate-slow" />
      </div>
